...
func InitOptionMap() {
	...
	common.OptionMap["RegisterWithRedemptionCodeEnabled"] = strconv.FormatBool(common.RegisterWithRedemptionCodeEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "RegisterWithRedemptionCodeEnabled":
			common.RegisterWithRedemptionCodeEnabled = boolValue
