...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/oauth/pending", middleware.CriticalRateLimit(), controller.GetPendingOAuthRegistration)
		apiRouter.POST("/oauth/register", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), controller.CompleteOAuthRegistration)
