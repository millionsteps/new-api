...
const (
	...
	MsgRedemptionRegisterOnly      = "redemption.register_only"
	MsgRedemptionRegisterDisabled  = "redemption.register_disabled"
...
const (
	...
	MsgUserRegisterRedemptionDisabled = "user.register_redemption_disabled"
	MsgUserRegisterRedemptionRequired = "user.register_redemption_required"
